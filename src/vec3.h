...
public:
    ...
    double &operator[](int i) { return e[i]; } // note: I'm not sure why this is required
...
{
    // v - 2 * b
    // v - 2 * (length of b * direction of b)
...
double schlick(double cosine, double ref_idx)
{
    ...
    // used to efficiently approximate Fresnel's equations
